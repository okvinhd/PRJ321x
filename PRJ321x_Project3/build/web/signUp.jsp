<%-- 
    Document   : signUp
    Created on : May 26, 2021, 11:19:52 PM
    Author     : VinhD
--%>
                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    <form action="loginProcess" method="POST">
                                        <div class="mb-3">
                                            <input type="text" name="signupusername" class="form-control form-control-lg" placeholder="admin" aria-label="Email" aria-describedby="email-addon">
                                        </div>
                                        <div class="mb-3">
                                            <input type="text" name="signuppassword" class="form-control form-control-lg" placeholder="passw0rd" aria-label="Password" aria-describedby="password-addon">
                                        </div>
                                        <div class="text-center">
                                            <p style="color: red">${messageSignUp}</p>
                                            <button type="submit" value="signup" name="action" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">Sign up</button>
                                        </div>
                                    </form>
                                </div>
