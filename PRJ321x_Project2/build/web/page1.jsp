<%-- 
    Document   : page1
    Created on : May 20, 2021, 12:23:12 AM
    Author     : VinhD
--%>
    ...
    <body class="case-study">
        ...
        <header>
            <div class="page-header section-height-85">
                <div>
                    <img class="position-absolute fixed-top ms-auto w-50 h-100 z-index-0 d-none d-sm-none d-md-block border-radius-section border-top-end-radius-0 border-top-start-radius-0 border-bottom-end-radius-0" src="https://demos.creative-tim.com/soft-ui-design-system/assets/img/curved-images/curved6.jpg" alt="image">
                </div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 d-flex">
                            <div class="card card-body blur text-md-left text-center px-sm-5 shadow-lg mt-sm-5 py-sm-5">
                                <h2 class="text-gradient text-primary mb-0">Welcome to Java Course</h2>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-3 col-6 p-0">
                                        <img class="w-100" src="https://demos.creative-tim.com/soft-ui-design-system/assets/img/logos/gray-logos/logo-pinterest.svg" alt="logo">
                                    </div>
                                    <div class="col-md-3 col-6 p-0">
                                        <img class="w-100" src="https://demos.creative-tim.com/soft-ui-design-system/assets/img/logos/gray-logos/logo-netflix.svg" alt="logo">
                                    </div>
                                    <div class="col-md-3 col-6 p-0">
                                        <img class="w-100" src="https://demos.creative-tim.com/soft-ui-design-system/assets/img/logos/gray-logos/logo-coinbase.svg" alt="logo">
                                    </div>
                                    <div class="col-md-3 col-6 p-0">
                                        <img class="w-100" src="https://demos.creative-tim.com/soft-ui-design-system/assets/img/logos/gray-logos/logo-nasa.svg" alt="logo">
                                    </div>
                                </div>
                            </div>
                        </div>
