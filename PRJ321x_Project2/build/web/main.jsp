<%-- 
    Document   : main.jsp
    Created on : May 19, 2021, 11:07:51 PM
    Author     : VinhD
--%>
...
<header class="header-2">
    <div class="page-header section-height-75 relative" style="background-image: url('https://demos.creative-tim.com/soft-ui-design-system/assets/img/curved-images/curved.jpg')">
      <div class="container">
        <div class="row">
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-4 ms-auto me-auto p-lg-4 mt-lg-0 mt-4">
          <div class="card card-background card-background-mask-primary tilt" data-tilt="" style="will-change: transform; transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);">
            ...
            <div class="card-body pt-7 text-center">
              ...
              <a href="https://demos.creative-tim.com/soft-ui-design-system//sections/elements/buttons.html" target="_blank" class="btn btn-outline-white mt-5 up btn-round">Start with Elements</a>
            </div>
          </div>
        </div>
      </div>
